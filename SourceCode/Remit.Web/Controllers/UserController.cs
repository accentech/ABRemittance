...
namespace Remit.Web.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IUserService userService, IRoleService roleService, ISecurityService securityService, IRoleSubModuleItemService roleSubModuleItemService, IWorkflowactionSettingService workflowactionSettingService, INotificationSettingService notificationSettingService)
        {
