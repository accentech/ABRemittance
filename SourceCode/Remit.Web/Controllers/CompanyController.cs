    ...
    public class CompanyController : Controller
    {
                ...
                if (permission.CreateOperation == true)
                {
                    ...
                    else
                    {
                        if (permission.UpdateOperation == true)
                        {
                            ...
                            companyObj.ShipmentAddress1 = company.ShipmentAddress1;
                            companyObj.ShipmentAddress2 = company.ShipmentAddress2;
                            companyObj.ShipmentAddress3 = company.ShipmentAddress3;
        ...
        public JsonResult GetCompanyList()
        {
            ...
            if (companyObj != null)
            {
                ...
                companyTemp.ShipmentAddress1 = companyObj.ShipmentAddress1;
                companyTemp.ShipmentAddress2 = companyObj.ShipmentAddress2;
                companyTemp.ShipmentAddress3 = companyObj.ShipmentAddress3;
