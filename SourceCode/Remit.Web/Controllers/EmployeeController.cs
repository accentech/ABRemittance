...
namespace Remit.Web.Controllers
{
  public class EmployeeController : Controller
  {
    ...
    public EmployeeController( IEmployeeService employeeService, ISubModuleItemService subModuleItemService, IRoleSubModuleItemService roleSubModuleItemService, IWorkflowactionSettingService workflowactionSettingService, INotificationSettingService notificationSettingService, IEmploymentHistoryService employmentHistoryService )
    {
...
//upload file..............
    ...
    public JsonResult GetEmployeeList()
    {
        ...
        foreach (var employee in employeeListObj)
        {
            ...
            if (employee.EmploymentHistories != null)
            {
                ...
                {
                    EmploymentHistoryViewModel empHistoryTemp = new EmploymentHistoryViewModel();
                    ...
                    if (empHistory.DateFrom != null)
                        empHistoryTemp.DateFrom = empHistory.DateFrom.Value.AddMinutes(timeZoneOffset).ToString(dateTimeFormat);
                    if (empHistory.DateTo != null)
                        empHistoryTemp.DateTo = empHistory.DateTo.Value.AddMinutes(timeZoneOffset).ToString(dateTimeFormat);
  ...
  public class EmployeeViewModel
  {
    ...
    {
      this.EmploymentHistories = new List<EmploymentHistoryViewModel>();
    }
    ...
    public List<EmploymentHistoryViewModel> EmploymentHistories;
  }
